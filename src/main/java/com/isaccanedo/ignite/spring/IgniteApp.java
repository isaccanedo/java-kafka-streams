package com.isaccanedo.ignite.spring;

import com.isaccanedo.ignite.spring.config.SpringDataConfig;
...
public class IgniteApp {
    ...
    private void getUsingTheCache(Integer employeeId) {
        ...
        IgniteCache<Integer, EmployeeDTO> cache = ignite.cache("isaccanedoCache");
