package com.isaccanedo.ignite.cache;

import com.isaccanedo.ignite.model.Employee;
...
public class IgniteCacheExample {
    ...
    public static void main(String[] args) {
        ...
        IgniteCache<Integer, String> cache = ignite.cache("isaccanedoCache");

        cache.put(1, "isaccanedo cache value");
    ...
    private static void getObjectFromCache(Ignite ignite) {
        ...
        IgniteCache<Integer, Employee> cache = ignite.getOrCreateCache("isaccanedoCache");
    ...
    private static void getFromCacheWithSQl(Ignite ignite) {
        ...
        IgniteCache<Integer, Employee> cache = ignite.cache("isaccanedoCache");
